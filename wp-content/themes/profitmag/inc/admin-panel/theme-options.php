                    ...
                    <form id="form-options" method="post" action="options.php">
            			...
            			<div id="options-group-2" class="group" style="display: none;">
            			     <h3><?php _e('Home Page Settings','profitmag'); ?></h3> 
                                ...
                                <div class="form-row inline-label">
                					<div class="block-section-title">Featured Block Five</div>
            			...
            			<div id="options-group-4" class="group" style="display: none;">
                            ...
                            <div class="option-sidebar-layout">
                                <div class="form-row form-row-layout-wrap clearfix">
                					<label for="sidebar_layout" class="sidebar_layout"><strong>Sidebar Layout</strong></label>
                            ...
                            <div class="option-left-sidebar">
                                ...
                                <div class="form-row inline-label">
                                        ...
                                        <p><?php _e( 'Please insert the image of size 302X222px', 'profitmag'); ?></p>		
              					</div>
                                ...
                                <div class="form-row inline-label">
                                        ...
                                        <p><?php _e( 'Please insert the image of size 302X592px', 'profitmag'); ?></p>		
              					</div>
                        ...
                        <div id="options-group-5" class="group" style="display: none;">
                            ...
                            <div class="form-row inline-label">
                                    ...
                                    <em class="f13"><?php _e( 'Please insert the image of size 790X90px', 'profitmag'); ?></em>		
          					</div>
                            <div class="form-row inline-label">
                                    ...
                                    <em class="f13"><?php _e( 'Please insert the image of size 855X91px', 'profitmag'); ?></em>		
          					</div>
